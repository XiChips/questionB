              ...
              <a-form :model="formState" autocomplete="off" @finish="onFinish" @finishFailed="onFinishFailed">
                <div class="line2">
                  ...
                  <a-form-item label="协议状态">
                    <a-select v-model:value="inputs.value2" placeholder="" style="width: 200px" :options="options2" :filter-option="filterOption" @focus="handleFocus" @blur="handleBlur" @change="handleChange">
                      <template #suffixIcon> <img src="" alt=""> </template>
                    </a-select>
                  </a-form-item>
                </div>
                <div class="line2">
                ...
                <div class="line2">
                  <a-form-item label="销售区域">
                    <a-button v-if="visible2" @click="selectCustom">选择区域</a-button>
                    <a-select v-if="!visible2" v-model:value="inputs.value1" show-search placeholder="" style="width: 200px" :options="options" :filter-option="filterOption" @focus="handleFocus" @blur="handleBlur" @change="changeCustom"></a-select>
                    <span v-if="!visible2" style="margin-left: 20px;">{{ inputs.value1 }}</span>
                  </a-form-item>
