          ...
          <div class="content">
            ...
            <div class="area">
              <a-tabs v-model:activeKey="activeKey2" type="card">
                <a-tab-pane key="1" tab="补充协议1">Content of Tab Pane 1</a-tab-pane>
                <a-tab-pane key="2" tab="补充协议2" force-render>Content of Tab Pane 2</a-tab-pane>
                <a-tab-pane key="3" tab="补充协议3">Content of Tab Pane 3</a-tab-pane>
              </a-tabs>
            </div>
