              ...
              <a-form :model="formState" autocomplete="off" @finish="onFinish" @finishFailed="onFinishFailed">
                ...
                <div class="line2">
                  <a-form-item label="销售区域">
                    ...
                    <a-select v-if="!visible2" v-model:value="inputs.value7c" placeholder="" style="width: 88px" :options="options4" :filter-option="filterOption" @focus="handleFocus" @blur="handleBlur" @change="changeArea" autofocus></a-select>
