        ...
        <a-layout-content :style="{ background: 'rgb(245,245,245)', padding: '0px', margin: 0, minHeight: '280px', }">
          ...
          <div class="content">
            ...
            <div class="area">
              ...
              <a-table :columns="columns2" :data-source="data2" bordered style="margin-top: 20px;">
              ...
              <a-table :columns="columns3" :data-source="data3" bordered style="margin-top: 20px;">
                <template #bodyCell="{ column, text, record }">
                  <template v-if="['col1',  'col3', 'col5',  'col7'].includes(column.dataIndex)">
                    <div>
                      <a-input v-model:value="record.key" style="margin: -5px 0" />
                    </div>
                  </template>
                  <template v-if="[ 'col2',  'col4',  'col6', ].includes(column.dataIndex)">
                    <div>
                      <a-select v-model:value="record.key" show-search placeholder="" :options="options" :filter-option="filterOption" @focus="handleFocus" @blur="handleBlur" @change="changeCustom"></a-select>
                    </div>
                  </template>
                </template>
              </a-table>
