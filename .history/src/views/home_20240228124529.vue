              ...
              <a-form :model="formState" autocomplete="off" @finish="onFinish" @finishFailed="onFinishFailed">
                <div class="line2">
                  ...
                  <a-form-item label="协议客户" :rules="[{ required: true}]">
                    ...
                    <a-select v-if="!visible" v-model:value="inputs.value1" show-search placeholder="" style="width: 200px" :options="options" :filter-option="filterOption" @focus="handleFocus" @blur="handleBlur" @change="changeCustom"></a-select>
                    <span style="margin-left: 20px;">{{ inputs.value1 }}</span>
                  </a-form-item>
                  <a-form-item label="协议状态">
                    <a-select defaultOpen v-model:value="inputs.value2" placeholder="" style="width: 200px" :options="options2" :filter-option="filterOption" @focus="handleFocus" @blur="handleBlur" @change="handleChange">
                      <template #suffixIcon>
                        <down-outlined />
                      </template>
                    </a-select>
                ...
                <div class="line2">
                  <a-form-item label="够进指标">
                    <a-select v-model:value="inputs.value3" placeholder="" style="width: 88px" :options="options3" :filter-option="filterOption" @focus="handleFocus" @blur="handleBlur" @change="handleChange"></a-select>
                    <a-input v-model:value="inputs.value3" placeholder="输入金额/数量" style="width: 150px;margin-left: 10px;"></a-input>
                  </a-form-item>
                ...
                <div class="line2">
                  <a-form-item label="销售区域">
                    ...
                    <a-select v-if="!visible2" v-model:value="inputs.value7c" placeholder="" style="width: 88px" :options="options4" :filter-option="filterOption" @focus="handleFocus" @blur="handleBlur" @change="changeArea"></a-select>
                    <a-button type="primary" v-if="inputs.value7.length" v-for="item in inputs.value7" style="margin-left: 20px;">{{ item }}</a-button>
                  </a-form-item>
