              ...
              <a-form :model="formState" autocomplete="off" @finish="onFinish" @finishFailed="onFinishFailed">
                ...
                <div class="line2">
                  <a-form-item label="够进指标" :rules="[{ required: true}]">
                    <a-select v-model:value="inputs.value3" show-search placeholder="" style="width: 88px" :options="options3" :filter-option="filterOption" @focus="handleFocus" @blur="handleBlur" @change="handleChange"></a-select>
