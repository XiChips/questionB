              ...
              <a-form :model="formState" autocomplete="off" @finish="onFinish" @finishFailed="onFinishFailed">
                ...
                <div class="line2">
                  <a-form-item label="销售区域">
                    ...
                    <a-select v-if="!visible2" v-model:value="inputs.value1" show-search placeholder="" style="width: 200px" :options="options4" :filter-option="filterOption" @focus="handleFocus" @blur="handleBlur" @change="changeCustom"></a-select>
                    <span style="margin-left: 20px;">{{ inputs.value1 }}</span>
                  </a-form-item>
