              ...
              <a-form :model="formState" autocomplete="off" @finish="onFinish" @finishFailed="onFinishFailed">
                <div class="line2">
                  ...
                  <a-form-item label="协议状态">
                    <a-select autofocus v-model:value="inputs.value2" placeholder="" style="width: 200px" :options="options2" :filter-option="filterOption" @focus="handleFocus" @blur="handleBlur" @change="handleChange">
                      <template #suffixIcon>
                        <down-outlined />
                      </template>
                    </a-select>
