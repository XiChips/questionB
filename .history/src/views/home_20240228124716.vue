              ...
              <a-form :model="formState" autocomplete="off" @finish="onFinish" @finishFailed="onFinishFailed">
                <div class="line2">
                  ...
                  <a-form-item label="协议客户" :rules="[{ required: true}]">
                    ...
                    <a-select defaultOpen v-if="!visible" v-model:value="inputs.value1" show-search placeholder="" style="width: 200px" :options="options" :filter-option="filterOption" @focus="handleFocus" @blur="handleBlur" @change="changeCustom"></a-select>
...
export default defineComponent({
  ...
  methods: {
    ...
    changeCustom() {
      this.visible = true
      this.inputs.value1 = this.inputs.value7c
    },
    selectArea() {
      this.visible2 = false
      this.inputs.value7c = ""
